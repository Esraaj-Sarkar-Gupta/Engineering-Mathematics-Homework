...
One may solve for the residual of the shooting function and required final value of $x$ using a numerical root-finding method to determine a suitable value for $s$. Here, the \textit{bijection method} is used. An example program in julia is given below.
\newpage
...
The program returns a result of $v(0) = 0.9999$ which may be approximated to $v(0) = 1 $. One may verify this result analytically.

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{question16/FS_solution.png}
